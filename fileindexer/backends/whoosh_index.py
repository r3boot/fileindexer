...
class WhooshIndex:
    ...
    _schema = whoosh.fields.Schema(
        ...
        compression_rate=whoosh.fields.TEXT(stored=True),
        ...
        audio_album=whoosh.fields.TEXT(stored=True),
        audio_artist=whoosh.fields.TEXT(stored=True),
        audio_author=whoosh.fields.TEXT(stored=True),
        audio_bitrate=whoosh.fields.TEXT(stored=True),
        audio_channel=whoosh.fields.TEXT(stored=True),
        audio_comment=whoosh.fields.TEXT(stored=True),
        ...
        audio_endianness=whoosh.fields.TEXT(stored=True),
        audio_framerate=whoosh.fields.TEXT(stored=True),
        audio_height=whoosh.fields.TEXT(stored=True),
        audio_language=whoosh.fields.TEXT(stored=True),
        audio_producer=whoosh.fields.TEXT(stored=True),
        audio_samplerate=whoosh.fields.TEXT(stored=True),
        audio_title=whoosh.fields.TEXT(stored=True),
        audio_width=whoosh.fields.TEXT(stored=True),
        ...
        file_framerate=whoosh.fields.TEXT(stored=True),
        file_height=whoosh.fields.TEXT(stored=True),
        file_language=whoosh.fields.TEXT(stored=True),
        ...
        subtitle_compression_rate=whoosh.fields.TEXT(stored=True),
        subtitle_language=whoosh.fields.TEXT(stored=True),
        subtitle_title=whoosh.fields.TEXT(stored=True),
        video_album=whoosh.fields.TEXT(stored=True),
        video_artist=whoosh.fields.TEXT(stored=True),
        video_author=whoosh.fields.TEXT(stored=True),
        video_bitrate=whoosh.fields.TEXT(stored=True),
        video_channel=whoosh.fields.TEXT(stored=True),
        video_comment=whoosh.fields.TEXT(stored=True),
        video_compression=whoosh.fields.TEXT(stored=True),
        video_compression_rate=whoosh.fields.TEXT(stored=True),
        video_duration=whoosh.fields.TEXT(stored=True),
        video_endianness=whoosh.fields.TEXT(stored=True),
        ...
        video_producer=whoosh.fields.TEXT(stored=True),
        video_samplerate=whoosh.fields.TEXT(stored=True),
